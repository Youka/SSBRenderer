...
protected:
  ...
  VideoInfo vi;
public:
  __stdcall ~GenericVideoFilter() {}    // Hack for GCC use of Avisynth
...
{
public:
  __stdcall ~AlignPlanar() {};    // Hack for GCC use of Avisynth
...
{
public:
  __stdcall ~FillBorder() {};    // Hack for GCC use of Avisynth
...
public:
  ...
  __stdcall ~ConvertAudio() {};    // Hack for GCC use of Avisynth
